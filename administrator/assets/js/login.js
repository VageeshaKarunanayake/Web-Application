function login()
{
        ...
        else
        {
            ...
            LCC.open("POST","../administrator/assets/php/login.php",true);
        ...
        if(LCC.readyState == 4){
            if(LCC.status == 200){
                ...
                if(retVal == '1')
                    ...
                    swal({ title: "Sucess",text: "Login successful",icon: "success"}).then(function(){window.location.replace("../administrator/dashboard/");});
