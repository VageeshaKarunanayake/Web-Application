...
<head>
    ...
    <title>Admin -Admin Managment Portal</title>
    ...
    <script src="assets/js/addAdministrator.js"></script>
    <script src="assets/js/updateAdministrator.js"></script>
    <script src="assets/js/viewAdministrators.js"></script>
...
<!--navigation for manage students-->
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./manageadmins.php"> Manage Admins </a>
                    </div>
            ...
            <!-- csv upload-->
            <div class="col-md-12">
                    <form class="md-form" id="uploadfileAdmin" action="assets/php/csvadmin.php" method="POST" enctype="multipart/form-data">
                                             <?php
                        if($_GET['status']=='succ'){
                    ...
                    <div class="modal-body">
                        <form id="updateAdministrator">
                                    <div class="card ">
                                        ...
                                        <div class="card-footer text-right">
                                            <button type="button" class="btn btn-info btn-fill pull-right" onclick="update_administrator()">Update</button>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </form>
