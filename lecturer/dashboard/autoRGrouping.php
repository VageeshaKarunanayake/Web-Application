...
<head>
    ...
    <script src="assets/js/autoRegularGroupCreation.js"></script>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php">Automatic Regular Grouping </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="section">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="autoRegularGroup" action="" method="">
                                    <div class="card ">
                                        <div class="card-header ">
                                            <h4 class="card-title">Create Automatic Groups</h4>
                                        </div>
                                        <div class="card-body ">
                                            ...
                                            <div class="form-group has-label">
                                                <label>
                                                    Student Count for above Selection
                                                    <star class="star">*</star>
                                                </label>
                                                <input class="form-control" name="count" min="1" id="count" type="number" />
                                            </div>
                                            <div class="form-group has-label">
                                                <label>
                                                    Grouping Criteria
                                                ...
                                                <select multiple data-title="GPA wise" name="criteria" disabled="true" id="criteria" class="selectpicker" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                                                        
                                                </select>
                                            </div>
                                            <div class="card-footer text-right">
                                                <button type="button" class="btn btn-info btn-fill pull-right" onclick="create_regular_groups()">Create Groups</button>
