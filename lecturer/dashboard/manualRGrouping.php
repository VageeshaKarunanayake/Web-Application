...
<head>
    ...
    <script src="assets/js/getModule_GroupID_Students.js"></script>
    <script src="assets/js/updateGroup.js"></script>
    <script src="assets/js/addGroups.js"></script>
    <script src="assets/js/viewGroups.js"></script>
    <script src="assets/js/viewGroupsAll.js"></script>
    <script src="assets/js/updateGroup.js"></script>
    <script src="assets/js/viewgroupmodal.js"></script>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php"> Manual Regular Grouping </a>
                    </div>
                                    ...
                                    <form id="addGroup" action="" method="">
                                        <div class="card ">
                                            ...
                                            <div class="form-group has-label">
                                                    ...
                                                    <select name="moduleCode" onchange="ID_StudentLoad()" class="selectpicker" id="MC" data-title="Select Module Code" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                                                ...
                                                <div class="form-group has-label">
                                                        ...
                                                        <input class="form-control" name="groupName" id="groupName" type="text" required="true" disabled="disabled" value="" />
                                                    </div>
                                                ...
                                                <div class="form-group has-label">
                                                        ...
                                                        <input class="form-control" name="memCount" id="memCount" min="1" type="number" onchange="restrict();" required="true" />
                                                    </div>
                                                <div class="form-group has-label">
                                                        <label>
                                                            Select Members
                                                        ...
                                                        <select multiple data-title="Select Members" name="members" id="members" class="selectpicker" data-style="btn-default btn-outline" data-menu-style="dropdown-blue" data-live-search="true">
                                        ...
                                        <div class="card ">
                                            ...
                                            <div class="form-group has-label">
                                                ...
                                                <div class="form-group has-label">
                                                        ...
                                                        <input class="form-control" name="memCount" id="memCount3" type="number" min="2" required="true" />
                                                    </div>
                                                <div class="form-group has-label">
                                                        <label>
                                                            Select Members
