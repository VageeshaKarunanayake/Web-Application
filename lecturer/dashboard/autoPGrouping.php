...
<head>
    ...
    <script src="assets/js/autoProrataGroupCreation.js"></script>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php"> Automatic Pro-Rata Grouping </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="section">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="autoProrataGroup" action="" method="">
                                    <div class="card ">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="form-group has-label">
                                                ...
                                                <select multiple data-title="Random" disabled="true" name="criteria" id="criteria" class="selectpicker" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                                                        
                                                </select>
                                            </div>
                                            <div class="card-footer text-right">
                                                <button type="button" class="btn btn-info btn-fill pull-right" onclick="create_prorata_groups()">Create Groups</button>
