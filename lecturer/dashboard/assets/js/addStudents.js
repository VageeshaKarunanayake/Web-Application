function register()
{
        ...
        else
        {
            ...
            var msg = "id=" + form.username.value.toUpperCase() + "&name=" + form.name.value + "&mobile=" + form.mobile.value + "&email=" + form.email.value + "&year=" + form.year.value + "&semester=" + form.semester.value + "&prorata=" + x;
            RS.send(msg);
        }
}
