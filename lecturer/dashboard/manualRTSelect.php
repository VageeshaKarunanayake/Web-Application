...
<head>
    ...
    <script src="assets/js/getModule_GroupID_Students_Topics.js"></script>
    <script src="assets/js/topic_allocation.js"></script>
    <script src="assets/js/viewTopics.js"></script>
    <script src="assets/js/viewTopicsAll.js"></script>
    <script src="assets/js/updateTopic.js"></script>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php"> Manual Regular Topic Selection </a>
                    </div>
