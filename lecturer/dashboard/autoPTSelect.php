...
<head>
    ...
    <script src="assets/js/autoProrataTopicAllocation.js"></script>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php"> Automatic Pro-Rata Topic Selection </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="section">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="autoPTopic" action="" method="">
                                    <div class="card ">
                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="card-footer text-right">
                                                <button type="button" class="btn btn-info btn-fill pull-right" onclick="prorata_topic_allocation_auto()">Allocate topics</button>
