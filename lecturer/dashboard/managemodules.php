...
<head>
    ...
    <script src="assets/js/addModule.js"></script>
    <script src="assets/js/viewModules.js"></script>
    <script src="assets/js/viewModulesAll.js"></script>
    <script src="assets/js/updateModule.js"></script>
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="./index.php"> Manage Modules </a>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="addModule" action="" method="">
                                    <div class="card ">
                                        ...
                                        <div class="card-body ">
                                            <div class="form-group has-label">
                                                    ...
                                                    <input class="form-control" name="moduleCode" id="moduleCode"type="text" />
                                                </div>
                                            ...
                                            <div class="form-group has-label">
                                                    ...
                                                    <input class="form-control" name="moduleName" id="moduleName"type="text"  />
                                                </div>
                                            <div class="form-group has-label">
                                                    <label>
                                                       Year
                                                    ...
                                                    <select name="year" class="selectpicker" id="year" data-title="Select Year" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                                        ...
                                        <div class="card-footer text-right">
                                            <button type="button" class="btn btn-info btn-fill pull-right" onclick="create_module()">Register</button>
            ...
            <div class="col-md-12">
                    <div class="card table-with-links">
                            ...
                            <div class="card-header has-label">
                                    ...
                                    <select name="year" class="selectpicker" onchange="viewModules()" id="year2" data-title="Select Year" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                ...
                <div class="modal-dialog">
                  <!-- Modal content-->
                    ...
                    <div class="modal-body">
                        <form id="updateModule" action="" method="">
                            <div class="card ">
                                <div class="card-header ">
                                ...
                                <div class="card-body ">
                                    <div class="form-group has-label">
                                            ...
                                            <input class="form-control" name="moduleCode" id="moduleCode3"type="text" />
                                        </div>
                                    ...
                                    <div class="form-group has-label">
                                            ...
                                            <input class="form-control" name="moduleName" id="moduleName3"type="text"  />
                                        </div>
                                    <div class="form-group has-label">
                                            <label>
                                               Year
                                            ...
                                            <select name="year" class="selectpicker" id="year3" data-title="Select Year" data-style="btn-default btn-outline" data-menu-style="dropdown-blue">
                                                    <option value="2">Year 2</option>
                                                    <option value="3">Year 3</option>
                                                    <option value="4">Year 4</option>
                                            </select>
                                ...
                                <div class="card-footer text-right">
                                    <button type="button" class="btn btn-info btn-fill pull-right" onclick="update_module()">Update</button>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </form>
