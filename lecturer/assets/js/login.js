function login()
{
        ...
        else
        {
            ...
            LCC.open("POST","../lecturer/assets/php/login.php",true);
        ...
        if(LCC.readyState == 4){
            if(LCC.status == 200){
                ...
                if(retVal == '1')
                    ...
                    swal({ title: "Sucess",text: "Login successful",icon: "success",}).then(function(){window.location.replace("../lecturer/dashboard/");});
                else
